...
class MenuItem(models.Model):
    ...
    category=models.ForeignKey(Category,on_delete=models.PROTECT) #Use PROTECT to prevent the deletion of a referenced object if there are still objects that depend on it
