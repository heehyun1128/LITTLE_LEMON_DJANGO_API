...
from .views import menu_item_list_view,menu_item_detail_view,all_managers_view,secret,manage_delivery_crew_view,delivery_crew_remove_view,cart_view,order_view,single_order_view,sort_menu_by_price
from rest_framework.authtoken.views import obtain_auth_token

urlpatterns = [
    path('menu-items/', menu_item_list_view, name='menu-item-list'),
    path('menu-items/sort=price',sort_menu_by_price , name='menu-item-sort_by_price'),
