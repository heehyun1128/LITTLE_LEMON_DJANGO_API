...
from .views import login_view,customer_register_view,menu_items_by_category_view,menu_item_list_view,menu_item_detail_view,category_view, all_managers_view,manage_delivery_crew_view,delivery_crew_remove_view,cart_view,order_view,single_order_view,sort_menu_by_price
